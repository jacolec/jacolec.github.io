$(document).ready(function() {
  const apiRoot = 'https://kodilla-tasks-prod-kodilla-tasks-x4kxw5.mo1.mogenius.io/v1/tasks/v1/tasks';
  const trelloApiRoot = 'https://kodilla-tasks-prod-kodilla-tasks-x4kxw5.mo1.mogenius.io/v1/tasks/v1/trello';
